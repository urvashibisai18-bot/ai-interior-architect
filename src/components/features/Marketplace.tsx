...
const allProducts = [
  { id: '1', name: 'Luxury Velvet Sofa', price: 65000, category: 'Sofa', style: 'luxury' as StyleType, color: '#8B0000', rating: 4.8, image: `${U}1555041467-a600c8d0e220?w=500&h=350&fit=crop` },
  { id: '2', name: 'Modern L-Shaped Sofa', price: 45000, category: 'Sofa', style: 'modern' as StyleType, color: '#4A4A4A', rating: 4.5, image: `${U}1493663284031-7b8663fd0767?w=500&h=350&fit=crop` },
  { id: '3', name: 'Gold Accent Platform Bed', price: 55000, category: 'Bed', style: 'luxury' as StyleType, color: '#D4AF37', rating: 4.9, image: `${U}1505693416388-f3c6f5a5e9b8?w=500&h=350&fit=crop` },
  ...
  { id: '5', name: 'Executive Walnut Desk', price: 22000, category: 'Desk', style: 'luxury' as StyleType, color: '#5C4033', rating: 4.7, image: `${U}1518455029719-f0d6e6f1236a?w=500&h=350&fit=crop` },
  { id: '6', name: 'Industrial Metal Desk', price: 15000, category: 'Desk', style: 'industrial' as StyleType, color: '#5C5C5C', rating: 4.3, image: `${U}1595514535413-5cbce93d7ef2?w=500&h=350&fit=crop` },
  { id: '7', name: 'Gold Arc Floor Lamp', price: 12000, category: 'Lamp', style: 'luxury' as StyleType, color: '#D4AF37', rating: 4.9, image: `${U}1513504637923-04bf7dad0e5a?w=500&h=350&fit=crop` },
  { id: '8', name: 'Crystal Table Lamp', price: 6500, category: 'Lamp', style: 'modern' as StyleType, color: '#F5F5DC', rating: 4.4, image: `${U}1507003212552-39f9b3f6e9a7?w=500&h=350&fit=crop` },
  { id: '9', name: 'Velvet Blackout Curtains', price: 12000, category: 'Curtains', style: 'luxury' as StyleType, color: '#1A1A2E', rating: 4.7, image: `${U}1613694023494-5b9a2a2b6ef5?w=500&h=350&fit=crop` },
  { id: '10', name: 'Linen Sheer Curtains', price: 6500, category: 'Curtains', style: 'scandinavian' as StyleType, color: '#F5F0EB', rating: 4.3, image: `${U}1525518392676-77b6c0c40d5f?w=500&h=350&fit=crop` },
  { id: '11', name: 'Gold Leaf Wall Art Set', price: 8500, category: 'Decor', style: 'luxury' as StyleType, color: '#D4AF37', rating: 4.8, image: `${U}1567098324869-f96d4ce5d7b0?w=500&h=350&fit=crop` },
